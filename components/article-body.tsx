    ...
    <article className="min-w-0">
      ...
      <div className="mt-5 space-y-5 text-base leading-[1.7] text-foreground md:text-lg">
        <p>
          ...
          used AI to suggest new approaches or search for advanced
      ...
      <div className="space-y-5 text-base leading-[1.7] text-foreground md:text-lg">
        <p>
          ...
          witnessed the same issue spreading through student work.
        </p>
      </div>
      ...
      <div className="space-y-5 text-base leading-[1.7] text-foreground md:text-lg">
        <p> He identifies
          three warning signs of AI over-reliance:</p>
